...
PROG = project1			# target executable (output)
HDRS = ProcessControlBlock.h GenOrderList.h PcbTable.h ReadyQueue.h
SRC = PcbTable.cpp ReadyQueue.cpp main.cpp       # .c or .cpp source files.
